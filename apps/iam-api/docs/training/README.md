...
本培训教程旨在帮助开发人员全面理解和掌握 `iam-api` 项目采用的 **Clean Architecture + CQRS + 事件驱动架构（EDA）** 组合架构模式。
...
- 项目源码：`apps/iam-api/src/`
- 示例模块：`apps/iam-api/src/lib/bounded-contexts/iam/authentication/`
- 测试代码：`apps/iam-api/tests/`
