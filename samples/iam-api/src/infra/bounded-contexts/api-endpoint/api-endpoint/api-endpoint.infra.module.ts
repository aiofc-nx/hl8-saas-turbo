...
import { ApiEndpointModule } from '@/lib/bounded-contexts/api-endpoint/api-endpoint/api-endpoint.module';
import {
  ApiEndpointReadRepoPortToken,
  ApiEndpointWriteRepoPortToken,
} from '@/lib/bounded-contexts/api-endpoint/api-endpoint/constants';
